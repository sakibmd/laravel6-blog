...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
           ...
           // Check Category Dir is exists
            ...
            $category->save();
            return redirect(route('author.category.index'))->with('success', 'Category Inserted Successfully');
    }
    ...
    public function edit($id)
    {
      ...
      $category_user_id = $categoryInfo->user_id;

      if($category_user_id != Auth::id()){
         return redirect(route('author.category.index'));
      } 
      return view('author.category.edit', ['category' => Category::find($id)]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $category->image = $imagename;
        $category->save();
         return redirect(route('author.category.index'))->with('success', 'Category Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        // Delete Old Image 
           ...
           if (Storage::disk('public')->exists('category/slider/'.$category->image)) {
             ...
             $category->delete();
              return redirect(route('author.category.index'))->with('success', 'Category Deleted Successfully');
     }
