    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <input type="text" id="email" class="form-control" placeholder="Enter your email"
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                        <label for="about">About Profile</label>
                                                    </div>
                                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                            <textarea class="form-control" id="about" name="about" cols="12" rows="5">{{ old('name', Auth::user()->about) }}</textarea>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                @method('PUT')
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                            <div class="form-group">
                                                <div class="form-line">
                                    <input type="password" id="confirm_password" class="form-control" placeholder="Enter your Conform Password"
