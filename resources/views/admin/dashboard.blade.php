        ...
        <div class="col-xs-12-3 col-sm-12 col-md-8 col-lg-9">
            <div class="card">
                      ...
                      @foreach($popular_posts as $key=>$post)
                           ...
                           <td>
                     @if($post->status == true)
                     <span style="font-size: 15px;" class="label bg-green">Published</span>

                     @else
                       <span style="font-size: 15px;" class="label bg-red">Pending </span>
                     @endif

                            </td>

                       <td> <a class="btn btn-sm btn-primary waves-efect" target="_blank" href="{{ route('post.details',$post->slug) }}"><span style="font-size: 15px;">View</span></a>  </td>
